...
//               V2/adc_8channel/adc_8channel.srcs/sources_1/ip/eth_data_fifo/eth_data_fifo_stub.v}
...
/* synthesis syn_black_box black_box_pad_pin="clk,rst,din[7:0],wr_en,rd_en,dout[7:0],full,empty,data_count[11:0],wr_rst_busy,rd_rst_busy" */;
  input clk;
  input rst;
  input [7:0]din;
  input wr_en;
