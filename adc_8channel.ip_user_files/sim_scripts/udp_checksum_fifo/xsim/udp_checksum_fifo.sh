...
#
# Generated by Vivado on Thu Aug 15 19:47:36 +0800 2024
...
# Script info
echo -e "udp_checksum_fifo.sh - Script generated by export_simulation (Vivado v2017.4 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L fifo_generator_v13_2_1 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot udp_checksum_fifo xil_defaultlib.udp_checksum_fifo xil_defaultlib.glbl -log elaborate.log
}
