...
HD_PWD='C:/Users/DELL/Desktop/CW4.team/adc_8channel V2/adc_8channel_sd_eth_1600_v1/adc_8channel/adc_8channel.runs/fifo5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo5.tcl
